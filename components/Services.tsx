...
import { Bot, Globe, Cog, Package, Cloud, TrendingUp, Mic } from "lucide-react";
...
const services: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      "Intelligent voice solutions powered by advanced conversational AI, real-time speech processing and tool use, and telephony integration, enabling automated calls and seamless integration with existing systems.",
    icon: <Mic size={40} />,
  },
  {
    id: "full-stack-dev",
